...
<style>
body{background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);min-height:100vh;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;padding:20px 0}
...
.brand h4{color:#667eea;font-weight:700;margin-bottom:5px}
...
.nav-pills .nav-link:hover{background-color:#fff;color:#667eea;transform:translateX(5px);box-shadow:0 4px 12px rgba(102,126,234,0.2)}
